...
ENV PHP_URL="https://secure.php.net/get/php-5.6.32.tar.xz/from/this/mirror" 
# env PHP_ASC_URL="https://secure.php.net/get/php-5.6.32.tar.xz.asc/from/this/mirror"
env PHP_ASC_URL=""
...
# ensure www-data user exists
	...
	&& adduser -u 82 -D -S -G docker www-data\	
